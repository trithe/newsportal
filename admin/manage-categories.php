                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><a href="edit-category.php?cid=<?= ($row['id']); ?>"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a>
                                                                &nbsp;<a href="manage-categories.php?rid=<?= ($row['id']); ?>&&action=del"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> </td>
                                                        </tr>
                                                    <?php
                                                        $cnt++;
                                                    } ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?= ($row['PostingDate']); ?></td>
                                                            <td><?= ($row['UpdationDate']); ?></td>
                                                            <td><a href="manage-categories.php?resid=<?= ($row['id']); ?>"><i class="ion-arrow-return-right" title="Restore this category"></i></a>
                                                                &nbsp;<a href="manage-categories.php?rid=<?= ($row['id']); ?>&&action=parmdel" title="Delete forever"> <i class="fa fa-trash-o" style="color: #f05050"></i> </td>
                                                        </tr>
                                                    <?php
                                                        $cnt++;
                                                    } ?>
