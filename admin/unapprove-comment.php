                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php $st = $row['status'];
                                                                ...
                                                                ?></td>
                                                            <td><a href="edit-post.php?pid=<?= ($row['postid']); ?>"><?= ($row['PostTitle']); ?></a> </td>
                                                            <td><?= ($row['postingDate']); ?></td>
                                                            <td>
                                                                <?php if ($st == '0') : ?>
                                                                    <a href="unapprove-comment.php?disid=<?= ($row['id']); ?>" title="Disapprove this comment"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a>
                                                                <?php else : ?>
                                                                    <a href="unapprove-comment.php?appid=<?= ($row['id']); ?>" title="Approve this comment"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a>
                                                                <?php endif; ?>
                                                                &nbsp;<a href="unapprove-comment.php?rid=<?= ($row['id']); ?>&&action=del"> <i class="fa fa-trash-o" style="color: #f05050"></i></a>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                        $cnt++;
