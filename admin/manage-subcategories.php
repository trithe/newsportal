                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= ($row['SubCatDescription']); ?></td>
                                                            <td><?= ($row['subcatpostingdate']); ?></td>
                                                            <td><?= ($row['subcatupdationdate']); ?></td>
                                                            <td><a href="edit-subcategory.php?scid=<?= ($row['subcatid']); ?>"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a>
                                                                &nbsp;<a href="manage-subcategories.php?scid=<?= ($row['subcatid']); ?>&&action=del"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> </td>
                                                        </tr>
                                                <?php
                                                                $cnt++;
                                                            }
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= ($row['subcatpostingdate']); ?></td>
                                                            <td><?= ($row['subcatupdationdate']); ?></td>
                                                            <td><a href="manage-subcategories.php?resid=<?= ($row['subcatid']); ?>"><i class="ion-arrow-return-right" title="Restore this SubCategory"></i></a>
                                                                &nbsp;<a href="manage-subcategories.php?scid=<?= ($row['subcatid']); ?>&&action=perdel"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> </td>
                                                        </tr>
                                                <?php
                                                                $cnt++;
                                                            }
