...
?>
    ...
    <head>
        ...
        <!-- App title -->
        <title><?= $company_name ?> | Contact us Page</title>
        <!-- Summernote css -->
                                        ...
                                        <div class="">
                                            <form name="aboutus" method="post">
                                                <div class="form-group m-b-20">
                                                    ...
                                                    <input type="text" class="form-control" id="pagetitle" name="pagetitle" value="<?= ($row['PageTitle']) ?>" required>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="card-box">
                                                            <h4 class="m-b-30 m-t-0 header-title"><b>Page Details</b></h4>
                                                            <textarea class="summernote" name="pagedescription" required><?= ($row['Description']) ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php } ?>
