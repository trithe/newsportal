...
?>
    ...
    <head>
        ...
        <!-- App title -->
        <title><?= $company_name ?> | Add Post</title>
        <!-- Summernote css -->
                                        ...
                                        <div class="">
                                            <form name="addpost" method="post">
                                                <div class="form-group m-b-20">
                                                    ...
                                                    <input type="text" class="form-control" id="posttitle" value="<?= ($row['title']); ?>" name="posttitle" placeholder="Enter title" required>
                                                </div>
                                                <div class="form-group m-b-20">
                                                ...
                                                <!-- <div class="form-group m-b-20">
                                                    ...
                                                    <select class="form-control" name="subcategory" id="subcategory" required>
                                                        <option value="<?= ($row['subcatid']); ?>"><?= ($row['subcategory']); ?></option>
                                                    </select>
                                                </div> -->
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="card-box">
                                                            ...
                                                            <textarea class="summernote" name="postdescription" required><?= ($row['PostDetails']); ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="card-box">
                                                            ...
                                                            <img src="postimages/<?= ($row['PostImage']); ?>" width="300" />
                                                            <br />
                                                            <a href="change-image.php?pid=<?= ($row['postid']); ?>">Update Image</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php } ?>
