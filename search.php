...
<head>
  <title><?= $company_name ?> | Search Page</title>
</head>
  ...
  <div class="container">
    <div class="row" style="margin-top: 4%">
      ...
      <div class="col-md-8">
        ...
        ?>
            <div class="card mb-4">
              <img class="card-img-top" src="admin/postimages/<?= ($row['PostImage']); ?>" alt="<?= ($row['posttitle']); ?>">
              <div class="card-body">
                <h2 class="card-title"><?= ($row['posttitle']); ?></h2>
                <a href="news-details.php?nid=<?= ($row['pid']) ?>" class="btn btn-primary">Read More &rarr;</a>
              </div>
